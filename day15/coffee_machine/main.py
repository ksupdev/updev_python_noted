...
def is_resource_suffucient(order_ingredients):
...
def is_transaction_successful(money_received, drink_cost):
    """Return True when the payment is accepted, or Faluse if money is insufficient. """
...
while is_on:
    ...
    if choice.lower() == "off" :
        ...
        drink = MENU[choice]
        if is_resource_suffucient(drink["ingredients"]):
